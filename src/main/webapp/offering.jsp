...
<body>
    <header>
        <div>
            <h1><a href="${pageContext.request.contextPath}/">Catalog</a> > ${offering.name}</h1>
        </div>
        ...
        <ul>
            ...
            <li>
                <c:choose>
                    ...
                    <c:otherwise>
                        <h4><a href="${pageContext.request.contextPath}/login?fromOffering=${offering.id}">Login</a> to leave a comment</h4>
                    </c:otherwise>
                </c:choose>
            </li>
        </ul>
