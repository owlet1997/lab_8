...
import static ru.ncedu.course.catalog_example.util.PathConstants.OFFERING_PATH;
        ...
        if(login == null || password == null) {
            ...
            try {
                ...
                if(fromOffering == null) {
                    getServletContext().getRequestDispatcher(PathConstants.SUCCESS_PAGE).forward(req,resp);
                } else {
                    getServletContext().getRequestDispatcher(OFFERING_PATH + "?id=" + fromOffering).forward(req, resp);
                }
